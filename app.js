...
app.use(function(req, res, next) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type,Origin,X-Requested-With,Content-Type,Accept,Key,Access-Control-Allow-Headers,token');
